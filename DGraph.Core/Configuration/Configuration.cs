...
namespace DGraph.Core.Configuration
{
    public class Configuration : IConfiguration
    {
        ...
        {
            var applications = ConfigurationManager.AppSettings["applications"];
            var applicationFilePaths = ConfigurationManager.AppSettings["applicationFilePaths"];
            var includedEntries = ConfigurationManager.AppSettings["includedEntries"];
            var excludedEntries = ConfigurationManager.AppSettings["excludedEntries"];
